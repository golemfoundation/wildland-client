...
class JiraStorageBackend(GeneratedStorageMixin, StorageBackend):
    ...
    SCHEMA = Schema({
        ...
        "type": "object",
        "required": ["workspace_url", "username", "personal_token"],
        "properties": {
            "workspace_url": {
                "$ref": "/schemas/types.json#http-url",
                "description": "address of the jira \"site\""
            },
            "username": {
                "type": "string",
            ...
            "projects_names": {
                ...
                "description": "(optional) names of projects within Jira \"site\"."
            }
        }
    })
    ...
    def __init__(self, **kwds):
        ...
        self.client = JiraClient(
            ...
            project_names=self.params.get('projects_names'),
    ...
    def cli_options(cls):
        return [
            click.Option(
                ...
                help='address of the jira "site"'),
            click.Option(
                ['--username'], required=True,
                help='Jira username; used for authorization purposes'),
            click.Option(
                ['--personal-token'], required=True,
                help='personal access token generated by Jira; used for authorization purposes'),
            click.Option(
                ['--projects-names'], required=False, multiple=True,
                help='(optional) Jira projects names')
        ]
    ...
    def cli_create(cls, data):
        return {
            ...
            'projects_names': list(data['projects_names']),
        }
