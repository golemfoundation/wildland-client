...
:command:`wl template create dropbox --app-key <app_key> [--refresh-token <refresh_token>] NAME`
------------------------------------------------------------------------------------------------
...
:command:`wl template add dropbox --app-key <app_key> [--refresh-token <refresh_token>] NAME`
---------------------------------------------------------------------------------------------
