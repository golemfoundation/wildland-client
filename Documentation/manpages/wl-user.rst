...
.. option:: --add-pubkey
   ...
   Public key to add (the same format as in the public key file or a Wildland user path). Can be repeated.
...
.. option:: --del-pubkey
   ...
   Public key to remove (the same format as in the public key file or a Wildland user path). Can be repeated.
