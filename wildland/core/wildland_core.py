...
# REMAINING TODO:
# TODO: WLEnv should provide support for various config api methods, such as add/remove default
#  containers, default_cache_template
# TODO: reporting progress - registering callbacks; reporting events from main-watch
# TODO: separate sync API
...
class WildlandCore:
    ...
    def start_wl(self, remount: bool = False, single_threaded: bool = False,
                 ...
                 default_user: Optional[str] = None) -> WildlandResult:
        """
