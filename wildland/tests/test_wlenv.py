...
def test_default_remotes(base_dir):
    ...
    assert not env.get_default_remote_for_container('0000').success
    ...
    assert not env.get_default_remote_for_container('2222').success
...
def test_aliases(base_dir):
    ...
    assert not env.get_alias('superuser').success
    ...
    assert not env.get_alias('u1').success
